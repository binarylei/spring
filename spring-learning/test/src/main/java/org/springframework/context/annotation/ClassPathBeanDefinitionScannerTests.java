...
public class ClassPathBeanDefinitionScannerTests {
    ...
    public void testSimpleScanWithDefaultFiltersAndPostProcessors() {
        ...
        assertTrue(context.containsBean("barComponent"));
    ...
    // includeAnnotationConfig=false 不注册对应注解的后置处理器
    @Test
