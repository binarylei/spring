...
public class QualifierAnnotationAutowireBeanFactoryTests {
    ...
    // SimpleAutowireCandidateResolver 的 isAutowireCandidate 与 DependencyDescriptor 无关
    @Test
    ...
    // SimpleAutowireCandidateResolver 由 BeanDefinition().isAutowireCandidate()
    // 本例中设置为 false
    @Test
    ...
    public void test2() throws Exception {
        ...
        DependencyDescriptor qualifiedDescriptor = new DependencyDescriptor(
                new MethodParameter(QualifiedTestBean.class.getDeclaredConstructor(Person.class), 0),
                false);
        assertTrue(beanFactory.isAutowireCandidate("person1", qualifiedDescriptor));
    }
